...
API_BASE = "https://ai-powered-movie-recommendation-system-ro67.onrender.com"or "http://127.0.0.1:8000"
...
qp_view = params.get("view", [None])[0]
qp_id = params.get("id", [None])[0]
